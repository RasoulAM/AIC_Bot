...
transitions = {
    ...
    (False, "reset"): main_menu,
    (None, "reset"): main_menu,
    (State.MAIN, "reset"): main_menu,
    (State.LOCATION, "reset"): main_menu,
    (State.PLATFORM_SHARIF_ID, "reset"): main_menu,
    (State.DELETE_PHOTO, "reset"): main_menu,
    (State.ADMIN_PANEL, "reset"): main_menu,
    (State.ANNOUNCEMENT, "reset"): main_menu,
    (State.ANSWER_OR_PASS, "reset"): main_menu,
    (State.ANSWERING, "reset"): main_menu,
    (State.ADDING_PHOTO, "reset"): main_menu,
    (State.ADD_PHOTO, "reset"): main_menu,
    (State.ANNOUNCING, "reset"): main_menu,
    (State.CONTACT_US, "reset"): main_menu,
    (State.INBOX, "reset"): main_menu,
    (State.INFORMATION, "reset"): main_menu,
    (State.PHOTOGRAPHY_CONTEST, "reset"): main_menu,
    (State.POLL, "reset"): main_menu,
    (State.PHOTOGRAPHY_CONTEST_RESULT, "reset"): main_menu,
    (State.SCHEDULE, "reset"): main_menu,
    (State.SCHEDULE_DAY1, "reset"): main_menu,
    (State.SCHEDULE_DAY2, "reset"): main_menu,
